...
class VideoDiscardScreen extends StatefulWidget {
  final String videoUrl;

  const VideoDiscardScreen({super.key, required this.videoUrl});

  @override
  State<VideoDiscardScreen> createState() => _VideoDiscardScreenState();
}

class _VideoDiscardScreenState extends State<VideoDiscardScreen> {
  ...
  final double _trimSelectionWidth = 30.0;
